...
class CEPerClass(Metric):
    ...
    def __init__(self, class_id):
        ...
        self.binary_cross_entropy = torch.nn.BCEWithLogitsLoss(reduction='sum')
    ...
    def update(self, preds: Tensor, target: Tensor) -> None:
        ...
        # Extract raw logits for the specific class (no softmax needed)
        ...
        output = self.binary_cross_entropy(logits, target)
